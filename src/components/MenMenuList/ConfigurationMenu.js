...
function ConfigurationMenu() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Verificar si se está editando un platillo
      if (editingDish) {
        ...
        if (result.isConfirmed) {
          ...
          setEditingDish(null);  // Resetear el platillo en edición
          // Redirigir al menú de platillos después de guardar
          navigate('/menu');  // Puedes modificar esto según tu ruta deseada
        }
      } else {
        // Si no se está editando, agregar un nuevo platillo
